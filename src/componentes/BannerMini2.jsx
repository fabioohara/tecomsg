...
const BannerMini2 = () => {
  ...
  return (
   ...
   <h2>Historias de Éxito de Nuestros Clientes</h2>
   <hr className='hrV'/>
   <p>Descubre como hemos ayudado a nuestros clientes</p>
   </div>
    <div className="banner-mini" style={{marginTop:"2rem"}}>
